...
public class SearchResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(count==0){
            ...
            a_builder=new AlertDialog.Builder(SearchResultActivity.this);
            a_builder.setMessage("No Record Found")
                    .setCancelable(false)
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent i=MainActivity.newIntentxid(SearchResultActivity.this,2,main_id);
                            startActivity(i);
                        }
                    });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                Intent i= SearchResultActivity1.newIntent1(SearchResultActivity.this,query,main_id);
                startActivity(i);
                return true;
            }
